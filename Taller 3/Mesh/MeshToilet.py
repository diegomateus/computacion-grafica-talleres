...
class MeshToilet:
  ...
  def draw1( self ):
    ...
    for i in range( nFaces ):
      ...
      glMaterialfv( GL_FRONT, GL_AMBIENT, [ 0.5880, 0.5880, 0.5880, 1.0 ] ) #Ka
      glMaterialfv( GL_FRONT, GL_DIFFUSE, [ 0.5880, 0.5880, 0.5880, 1.0 ] ) #Kd
      glMaterialfv( GL_FRONT, GL_SPECULAR, [ 0.2700, 0.2700, 0.2700, 1.0 ] ) #Ks
      glMaterialfv( GL_FRONT, GL_SHININESS, [ 51 ] ) #NS
