...
class MeshEspada:
  ...
  def draw1( self ):
    ...
    for i in range( nFaces ):
      ...
      glMaterialfv( GL_FRONT, GL_AMBIENT, [ 1.0, 1.0, 1.0, 1.0 ] ) #Ka
      glMaterialfv( GL_FRONT, GL_DIFFUSE, [ 0.175, 0.175, 0.175, 1.0 ] ) #Kd
      glMaterialfv( GL_FRONT, GL_SPECULAR, [ 0.743, 0.743, 0.743, 1.0 ] ) #Ks
      glMaterialfv( GL_FRONT, GL_SHININESS, [ 96 ] ) #NS
